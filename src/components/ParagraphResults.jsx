...
import '../styles/ParagraphResults.css';

const ParagraphResults = memo(({
  successRate,
  errorsPerMinute,
  avgTimePerParagraph,
  paragraphsCompleted,
  ...
  return (
    <motion.div className="paragraph-results-container" {...containerAnimation}>
...
ParagraphResults.displayName = 'ParagraphResults';
